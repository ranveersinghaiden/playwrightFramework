 ...
 *
 * Products   : myeroad */
public class Validate_api_API_responseApiTest {
    ...
    @Test
    @DisplayName("Validate api API response")
    void test_validate_api_api_response() {
        // GIVEN
        ...
        // THEN
        // I should receive a successful response with the expected data
    }
}
