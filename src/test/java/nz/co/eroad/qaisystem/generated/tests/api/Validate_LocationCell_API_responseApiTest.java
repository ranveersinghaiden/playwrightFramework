 ...
 *
 * Products   : myeroad */
public class Validate_LocationCell_API_responseApiTest {
    ...
    @Test
    @DisplayName("Validate LocationCell API response")
    void test_validate_locationcell_api_response() {
        // GIVEN
        // the LocationCell API is available
        ...
        // THEN
        // I should receive a successful response with the expected location data
    }
}
