 ...
 *
 * Products   : myeroad */
public class Validate_DataRetention_API_responseApiTest {
    ...
    @Test
    @DisplayName("Validate DataRetention API response")
    void test_validate_dataretention_api_response() {
        // GIVEN
        // the DataRetention API is available
        ...
        // THEN
        // I should receive a successful response with the expected retention policy data
    }
}
