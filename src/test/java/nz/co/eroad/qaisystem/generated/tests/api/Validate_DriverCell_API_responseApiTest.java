 ...
 *
 * Products   : myeroad */
public class Validate_DriverCell_API_responseApiTest {
    ...
    @Test
    @DisplayName("Validate DriverCell API response")
    void test_validate_drivercell_api_response() {
        // GIVEN
        // the DriverCell API is available
        ...
        // THEN
        // I should receive a successful response with the expected driver information
    }
}
