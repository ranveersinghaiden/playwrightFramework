 ...
 *
 * Products   : myeroad */
public class Validate_DateTimeLogonCell_API_responseApiTest {
    ...
    @Test
    @DisplayName("Validate DateTimeLogonCell API response")
    void test_validate_datetimelogoncell_api_response() {
        // GIVEN
        // the DateTimeLogonCell API is available
        ...
        // THEN
        // I should receive a successful response with the expected date and time data
    }
}
