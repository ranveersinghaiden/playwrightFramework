 ...
 *
 * Products   : myeroad */
public class Validate_types_API_responseApiTest {
    ...
    @Test
    @DisplayName("Validate types API response")
    void test_validate_types_api_response() {
        // GIVEN
        // the types API is available
        ...
        // THEN
        // I should receive a successful response with the expected type definitions
    }
}
