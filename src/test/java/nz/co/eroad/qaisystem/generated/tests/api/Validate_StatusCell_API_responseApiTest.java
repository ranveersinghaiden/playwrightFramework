 ...
 *
 * Products   : myeroad */
public class Validate_StatusCell_API_responseApiTest {
    ...
    @Test
    @DisplayName("Validate StatusCell API response")
    void test_validate_statuscell_api_response() {
        // GIVEN
        // the StatusCell API is available
        ...
        // THEN
        // I should receive a successful response with the expected status information
    }
}
